            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="#">{{ __('Comprar') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">{{ __('Vender') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('publicidad') }}">{{ __('Publicidad') }}</a>
                        </li>
                    </ul>
                        ...
                        <!-- Authentication Links -->
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('account') }}">Cuenta</a>
